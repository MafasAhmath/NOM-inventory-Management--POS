...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2024 at 09:11 PM
...
--
-- Stand-in structure for view `brandview`
...
(142, '', '', 'male', '', '', ''),
(143, 'ffff', '', 'male', '', '', ''),
(144, 'ffff', 'ffre ', 'male', '0778325759', 'mafasahmath@gmail.com', ''),
(145, '', '', 'male', '', '', ''),
(146, '', '', 'male', '', '', ''),
(147, 'gg gg', '', 'male', '', '', 'ggg'),
(148, 'ff ff', 'Ah math', 'male', '0778325759', 'mafasahmath@gmail.com', ''),
(149, 'hh', 'hh', 'male', '0778325759', 'mafasahmathgmai', 'hhh'),
(150, 'hh', 'hh', 'male', '0778325759', 'mafasahmath@gmail.com', 'ggg');
...
('grees', 'grease', 6, 1, 1, 1, 3000, 3500, 20, 'grease-Automatic Transmission Oils-Caltex Havoline-Chevron Sri Lanka'),
('p01', 'Havoline Super 4T SAE 10W-30', 6, 1, 1, 1, 1500, 1650, 20, 'Havoline Super 4T SAE 10W-30-Automatic Transmission Oils-Caltex Havoline-Chevron Sri Lanka'),
('p03', 'gear', 7, 1, 1, 5, 1000, 1500, 10, 'gear-Automatic Transmission Oils-Caltex Havoline-cda'),
('p082', 'DS 40', 6, 1, 1, 1000, 1500, 2000, 20, 'DS 40-Automatic Transmission Oils-Caltex Havoline-Chevron Sri Lanka'),
('p10', '20w 50', 6, 1, 1, 1, 1500, 2000, 24, '20w 50-Automatic Transmission Oils-Caltex Havoline-Chevron Sri Lanka'),
('p11', '2T oil', 6, 1, 1, 0, 30, 35, 50, '2T oil-Four Stroke Motor Cycle Engine Oils-Caltex Havoline-Chevron Sri Lanka'),
('p12', 'Delo', 6, 1, 1, 5, 4500, 5000, 4, 'Delo-Automatic Transmission Oils-Caltex Havoline-Chevron Sri Lanka'),
('p6', '15w 40', 6, 1, 1, 1, 1500, 2000, 20, '15w 40-Four Stroke Motor Cycle Engine Oils-Caltex Havoline-Chevron Sri Lanka');
...
(3, 'fathima', 'bagem', 'female', '0774275224', 'bagem@gmail.com', '144255656556');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `brandview`  AS SELECT `brand`.`b_id` AS `b_id`, `brand`.`name` AS `brand_name`, `company`.`name` AS `company_name` FROM (`brand` left join `company` on(`company`.`company_id` = `brand`.`company_id`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `companyview`  AS SELECT `company`.`company_id` AS `company_id`, `company`.`name` AS `company_name`, concat(`supplier`.`f_name`,' ',`supplier`.`l_name`) AS `supplier_name` FROM (`company` left join `supplier` on(`company`.`supplier_id` = `supplier`.`s_id`)) ;
...
--
ALTER TABLE `customer`
  MODIFY `cstmr_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
